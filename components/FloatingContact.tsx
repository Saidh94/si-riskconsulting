    ...
    <div className="fixed bottom-5 right-5 z-50 flex flex-col items-end gap-2">
      ...
      >
        <a
          ...
          className="flex items-center gap-2.5 px-4 py-2.5 rounded-full bg-[#0a0f1e] border border-white/10 text-white text-sm font-medium shadow-lg hover:border-[#0A66C2]/60 transition-colors"
        >
